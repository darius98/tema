...
function(AddTemaTarget TYPE NAME)
    ...
    elseif (TYPE STREQUAL "SHARED_LIBRARY")
        ...
        target_compile_options(${NAME} PRIVATE -fPIC -fPIE -fvisibility=hidden -fvisibility-inlines-hidden)
        target_link_options(${NAME} PRIVATE -fPIC -fPIE -fvisibility=hidden -fvisibility-inlines-hidden)
...
function(AddTemaSharedLibrary NAME)
    AddTemaTarget(SHARED_LIBRARY ${NAME} ${ARGN})
endfunction()
